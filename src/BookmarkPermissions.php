...
/**
 * Provides dynamic permissions for Bookmark of different types.
 *
 * @ingroup bookmarks
 *
 */
class BookmarkPermissions{
   ...
   *
   * @return array
   *   The Bookmark by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (Bookmark::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\bookmarks\Entity\Bookmark $type
   *   The Bookmark type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(Bookmark $type) {
    $type_id = $type->id();
